          ...
          <div className="bg-white rounded-2xl border border-[rgba(138,130,120,0.12)] shadow-lg overflow-hidden">
            <div className="p-5">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between"><span className="text-warm-gray">{t('common.total')}</span><span className="font-bold" style={{color: theme.primary}}>${total.toFixed(2)} USD</span></div>
              </div>
            </div>
          </div>
        </div>
