      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border border-[rgba(0,0,0,0.06)] shadow-sm">
          <CardHeader className="text-center pb-2">
            <CardTitle className="font-display text-xl text-deep-navy">Sign In</CardTitle>
            <p className="font-body text-xs text-warm-gray mt-1">
              Access your transportation company dashboard
            </p>
          </CardHeader>
          <CardContent>
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-3 text-warm-gray">or</span>
              </div>
            </div>
