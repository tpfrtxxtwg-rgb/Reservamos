    ...
    ? `<div style="margin-bottom:24px;">
        ...
        <div style="display:flex;flex-wrap:wrap;">
          <div style="flex:1;min-width:200px;padding-right:12px;">
            ...
            <div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.destinationName || booking.destination || "N/A"}</div>
            ...
            <div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Departure Date</div>
            <div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureDate || "N/A"}</div>
            <div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Departure Flight Time</div>
            <div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureTime || "N/A"}</div>
          </div>
          <div style="flex:1;min-width:200px;">
            <div style="font-size:11px;color:#8A8278;margin-bottom:2px;">Hotel Pickup Time</div>
            <div style="font-size:13px;color:#2D6A4F;font-weight:700;">${booking.hotelPickupTime || pickupTime || "N/A"}</div>
            ${booking.departureAirline ? `<div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Airline</div><div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureAirline}</div>` : ""}
            ${booking.departureFlightNumber ? `<div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Flight Number</div><div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureFlightNumber}</div>` : ""}
          </div>
        </div>
...
function buildTextEmail(
  ...
  if (isRoundTrip) {
    ...
    text += `Departure Date: ${booking.departureDate || "N/A"}\n`;
    text += `Departure Flight Time: ${booking.departureTime || "N/A"}\n`;
    text += `Airline: ${booking.departureAirline || "N/A"}\n`;
  ...
  const roundTripHtml = isRoundTrip
    ? `<div style="margin-bottom:24px;"><div style="background:#F5EFE6;padding:10px 12px;font-size:12px;font-weight:bold;color:#3D3833;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:12px;border-radius:6px;">DEPARTURE INFORMATION</div>
        <div style="display:flex;flex-wrap:wrap;"><div style="flex:1;min-width:200px;padding-right:12px;">
          ...
          <div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Departure Date</div><div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureDate || "N/A"}</div>
          <div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Departure Flight Time</div><div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureTime || "N/A"}</div>
        </div><div style="flex:1;min-width:200px;">
          <div style="font-size:11px;color:#8A8278;margin-bottom:2px;">Hotel Pickup Time</div><div style="font-size:13px;color:#2D6A4F;font-weight:700;">${booking.hotelPickupTime || pickupTime || "N/A"}</div>
          ${booking.departureAirline ? `<div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Airline</div><div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureAirline}</div>` : ""}
          ${booking.departureFlightNumber ? `<div style="font-size:11px;color:#8A8278;margin-bottom:2px;margin-top:8px;">Flight Number</div><div style="font-size:13px;color:#3D3833;font-weight:600;">${booking.departureFlightNumber}</div>` : ""}
        </div></div>
        <div style="margin-top:8px;font-size:11px;color:#8A8278;font-style:italic;">* Se recomienda agendar la reserva 3 horas antes de su vuelo</div></div>`
    : "";
